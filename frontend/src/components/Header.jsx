...
export default function Header() {
  ...
  const SECONDARY_ITEMS = [
    { to: "/profile", key: "profile", Icon: User, show: true },
    { to: "/my-goods", key: "myGoods", Icon: ShoppingBag, show: canSeeMyGoods },
    { to: "/orders", key: "orders", Icon: ClipboardList, show: canSeeOrders },
  ].filter((i) => i.show);
            ...
            <Dialog.Root>
              ...
              <Dialog.Portal>
                ...
                >
                  ...
                  {/* Тонкая полоса сразу под заголовком Menu */}
